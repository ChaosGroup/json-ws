...
class ServiceRegistry {
	constructor(options) {
		this.rootPath = options.rootPath.replace(/\/*$/gi, '');
	...
	attachExpressRouter() {
		this.expressApp.all(`${this.rootPath}/*`, (req, res, next) => {
	...
	addTransport(transportConstructor) {
		const transportInstance = new transportConstructor(this);
